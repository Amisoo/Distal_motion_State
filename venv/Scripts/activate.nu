...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\arthur.herbette\PycharmProjects\state csv\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\arthur.herbette\PycharmProjects\state csv\venv\Scripts\deactivate.nu'
